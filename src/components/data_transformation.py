...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path, 
        ...
        try:
            ...
            input_feature_train_array = preprocessor_obj.fit_transform(input_train_features_df).toarray()
            input_feature_test_array = preprocessor_obj.transform(input_test_features_df).toarray()
